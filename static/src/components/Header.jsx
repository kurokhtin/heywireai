		...
		<header class="dashboard">
			...
			<div class="menu_items">
				<ul class="">
					...
					<li><a aria-current="page" class="active" href="/dashboard/profile/">
					<span>My Profile</span></a></li>*/}
				</ul>
				<div id="menu_toggle_wrap" class=""><span></span><span></span><span></span></div>
			</div>
			<div class="right_header logged">
				<div class="top_right_header">
					<div class="welcome_user"><h3>Hi, Alex</h3>
